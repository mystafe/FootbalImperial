...
function App() {
  ...
  // World Domination init removed for Football-only repo

  // Helper: schedule AI placement loop that places one army per AI turn sequentially
  // World Domination AI placement removed
  // World Domination helpers removed
  ...
  // Game mode selection removed — default to Football
  ...
  return (
    <div>
      ...
      <div className="w-full p-0 bg-gradient-to-br from-slate-900/50 via-blue-900/30 to-slate-900/50 backdrop-blur-sm min-h-screen">
              ...
              <div className="relative p-6">
                <div className="grid gap-5 lg:grid-cols-2">
                  ...
                  <div className="space-y-5">
                    {/* Game mode selector removed (Football-only) */}
                    <div className="group">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                          ...
                          // World Domination overrides removed
                      setConfig(newConfig)
                      saveConfig(newConfig)
                    }}
        ...
        {/* World Domination UI removed in Football-only build */}
        {/* World Domination Landing removed */}
      </div>
